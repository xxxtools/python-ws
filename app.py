...
# 环境变量
UUID = os.environ.get('UUID', '52ec8be9-7e68-4e95-88d4-86a2c0b13206')   # 节点UUID
NEZHA_SERVER = os.environ.get('NEZHA_SERVER', 'tta.wahaaz.xx.kg:80')    # 哪吒v0填写格式: nezha.xxx.com  哪吒v1填写格式: nezha.xxx.com:8008
NEZHA_PORT = os.environ.get('NEZHA_PORT', '')        # 哪吒v1请留空，哪吒v0 agent端口
NEZHA_KEY = os.environ.get('NEZHA_KEY', 'OZMtCS6G39UpEgRvzRNXjS7iDNBRmTsI')          # 哪吒v0或v1密钥，哪吒面板后台命令里获取
DOMAIN = os.environ.get('DOMAIN', '')                # 项目分配的域名或反代后的域名,不包含https://前缀,例如: domain.xxx.com
SUB_PATH = os.environ.get('SUB_PATH', 'sub')         # 节点订阅token
NAME = os.environ.get('NAME', 'renusnp')                    # 节点名称
